...
seed2=$RANDOM
seed3=$RANDOM
./corsika77400Linux_EPOS_urqmd <<EOF >./epos_urqmd/result.txt
RUNNR   $i                             run number                                
...
ERANGE  1.E4  1.E4                    energy range of primary particle (GeV)
...
DIRECT  ./epos_urqmd/                              output directory
*OUTFILE ./epos_urqmd/inter1st.dat                  secondary particles of first interaction
USER    qinjian                        user 
